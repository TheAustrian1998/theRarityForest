...
contract theForestProxyItems {
    ITheRarityForestV3 constant _forest = ITheRarityForestV3(0x48e6F88F1Ab05677675dE9d14a705f8A137ea2bC);
    ...
    function items(uint _itemID) public view returns (item memory) {
		...
		if (compareStrings(_itemName, "Unknown animal eye")) return (item(1, 26));
